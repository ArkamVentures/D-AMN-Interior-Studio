      ...
      <section className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 border-b border-white/5">
        ...
        >
          ...
          <p className="text-gray-300 text-lg md:text-xl leading-relaxed mb-6 max-w-3xl">
            Damn Aluminium Fabrication is a leading aluminium fabrication and industrial solutions provider in Dharga Town, Sri Lanka. We design, build and install custom aluminium assemblies, shopfronts, partitions, cladding, gutter systems, and structural fixtures for commercial and residential projects.
          </p>
          
          <p className="text-gray-300 text-lg md:text-xl leading-relaxed mb-12 max-w-3xl">
            Driven by skilled craftsmanship and modern execution, we deliver robust, low-maintenance solutions with free site visits and a commitment to durable, professional results.
          </p>
          ...
          >
            ...
            <div className="text-center flex-grow flex flex-col">
              ...
              <p className="text-gray-300 text-sm md:text-base leading-relaxed mb-6 flex-grow text-balance">
                "Visionary founder behind Damn Aluminium Fabrication with 20+ years of hands-on experience in aluminium fabrication and industrial solutions. Nowful leads the company with deep industry expertise, a passion for precision, and an unwavering commitment to quality craftsmanship. From concept to completion, he ensures every project reflects durability, innovation, and timeless finish."
              </p>
              ...
              <div className="flex justify-center items-center gap-4 mt-auto pt-4 border-t border-white/5">
                ...
                <a
                  href="mailto:damnaluminiumfabrication@gmail.com"
