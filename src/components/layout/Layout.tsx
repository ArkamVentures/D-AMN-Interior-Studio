...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-warm-gray dark:bg-dark-bg text-primary dark:text-gray-100 transition-colors duration-300">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
          ...
          <div className="mb-4">
            ...
            <div className="flex justify-center items-center gap-4">
              ...
              <a href="https://wa.me/94773724849?text=Hi%2C%20I'm%20interested%20in%20aluminium%20fabrication%20services" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white hover:text-[#25D366] hover:bg-[#25D366]/10 hover:scale-110 hover:shadow-[0_0_15px_rgba(37,211,102,0.5)] transition-all duration-300" aria-label="WhatsApp">
      ...
      <a
        href="https://wa.me/94773724849?text=Hi%2C%20I'm%20interested%20in%20aluminium%20fabrication%20services"
        target="_blank"
