          ...
          >
            ...
            <div>
              ...
              <div className="flex items-center gap-4 pl-3">
                ...
                <a href="https://wa.me/94773724849?text=Hi%2C%20I%27m%20interested%20in%20aluminium%20fabrication%20services" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-black border border-white/10 flex items-center justify-center text-white hover:text-[#25D366] hover:scale-110 hover:shadow-[0_0_15px_rgba(37,211,102,0.5)] transition-all duration-300" aria-label="WhatsApp">
